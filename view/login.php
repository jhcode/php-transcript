...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Precure Authentication</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0"> 
        <meta name="author" content="Joseph Rex">
        <link rel="shortcut icon" href="favicon.png">
        <?= HTML::stylesheet('demo.css'); ?>
        <?= HTML::stylesheet('style.css'); ?>
        <?= HTML::stylesheet('animate-custom.css'); ?>
    </head>
    <body>
        <div class="container">
            <header>
                <h1>Login or Register <span><a href="<?= url(); ?>">with Precure</a></span></h1>
            </header>
            <section>				
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form method="post"  action="<?= url() ?>/auth" id="authForm" autocomplete="on"> 
                                <h1>Log in</h1>
                                ...
                                <p class="keeplogin"> 
									<input type="checkbox" name="stayInside" id="loginkeeping" value="true" /> 
